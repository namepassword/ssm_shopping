$(function() {
	...
	var infoUrl = '/gradudes/shopadmin/getproductbyid?productId=' + productId;
	//获取当前店铺设定的商品类别列表
	var categoryUrl = '/gradudes/shopadmin/getproductcategorylist';
	//更新商品信息的URL
	var productPostUrl = '/gradudes/shopadmin/modifyproduct';
	//由于商品添加合编辑使用的是同一个页面
	//该标识符用来标明是添加还是编辑操作
	var isEdit = false;
	if (productId) {
		...
		getCategory();
		productPostUrl = '/gradudes/shopadmin/addproduct';
	}
